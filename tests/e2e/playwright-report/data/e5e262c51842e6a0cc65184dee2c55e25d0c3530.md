...
- Name: all-journeys.spec.ts >> MindFlow E2E – All Journeys >> Journey 1 – 单项目完整链路 (AC-1~AC-5)
- Location: tests/e2e/all-journeys.spec.ts:42:7

# Error details

```
Error: AC-6 创建项目: locator.click: Timeout 15000ms exceeded.
Call log:
